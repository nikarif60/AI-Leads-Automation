...
export function priorityLeadKeyboard(lead, appUrl = "") {
  ...
  const bmDraft = String(lead.draft_bm || `Hi ${lead.business_name},\n\nSaya dari NykStack. Saya nampak peluang untuk memudahkan pelanggan memahami bisnes anda dan menghubungi anda. Adakah anda terbuka untuk melihat contoh ringkas?`);
