    ...
    <div className="lead-detail-page">
      ...
      <div className="detail-grid">
        ...
        <aside className="detail-aside">
          <section className="detail-block contact-block"><h2>Business details</h2><div><MapPin /><span><small>Address</small>{lead.address}</span></div><div><Phone /><span><small>Phone / WhatsApp</small>{lead.phone}</span></div>{lead.website && <a href={lead.website} target="_blank" rel="noreferrer"><Globe /><span><small>Website</small>Open website</span></a>}{lead.social && <a href={lead.social} target="_blank" rel="noreferrer"><InstagramLogo /><span><small>Social</small>Open public profile</span></a>}<StatusBadge status={lead.websiteStatus} /></section>
